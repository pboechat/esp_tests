...
static const uint32_t g_exp_lut_32[256] = {
    ...
    0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
    0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
    0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000001, 0x00000002, 0x00000005, 0x0000000D,
    0x00000023, 0x0000005E, 0x00000100, 0x000002B8, 0x00000764, 0x00001416, 0x00003699, 0x0000946A, 0x0001936E,
    0x000448A2, 0x000BA4F5, 0x001FA715, 0x00560A77, 0x00E9E224, 0x027BC2CB, 0x06C02D64, 0x1259AC49, 0x31E1995F,
    0x87975E85, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
...
// -----------------------------------------------------------------------------
// dense (int8)
static void dense_int8(const int8_t *inputs, int8_t input_zp, const int8_t *weights, const int8_t *weight_zps,
                       const int32_t *biases, int8_t *outputs, int8_t output_zp, const uint32_t *multipliers,
                       const int32_t *shifts, uint32_t input_size, uint32_t output_size)
{
...
// -----------------------------------------------------------------------------
// dense + ReLU (int8)
static void dense_relu_int8(const int8_t *inputs, int8_t input_zp, const int8_t *weights, const int8_t *weight_zps,
                            const int32_t *biases, int8_t *outputs, int8_t output_zp, const uint32_t *multipliers,
                            const int32_t *shifts, uint32_t input_size, uint32_t output_size)
{
    dense_int8(inputs, input_zp, weights, weight_zps, biases, outputs, output_zp, multipliers, shifts, input_size,
               output_size);
...
static void forward_pass(const int8_t *inputs, int8_t *outputs)
{
    ...
    dense_relu_int8(inputs, input_zp, hidden_weights, hidden_weight_zps, hidden_biases, hiddens, hidden_zp,
                    layer1_multipliers, layer1_scales, INPUT_SIZE, HIDDEN_SIZE);

    // 2) dense (no activation) for final logits
    dense_int8(hiddens, hidden_zp, output_weights, output_weight_zps, output_biases, outputs, output_zp,
               layer2_multipliers, layer2_scales, HIDDEN_SIZE, OUTPUT_SIZE);
